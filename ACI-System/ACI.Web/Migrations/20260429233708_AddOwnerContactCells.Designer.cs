...
namespace ACI.Web.Migrations
{
    ...
    [Migration("20260429233708_AddOwnerContactCells")]
    partial class AddOwnerContactCells
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("AuthoredByName")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("NoWorkReason")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReportCrewEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DailyReportCrewEntries");
                });

            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReportEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DailyReportEquipment");
                });

            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReportFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DailyReportFiles");
                });

            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReportTaskProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("ProgressAfter")
                        .HasColumnType("double precision");

                    b.Property<double>("ProgressBefore")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("DailyReportTaskProgress");
                });

            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReportWorkItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("WorkerHours")
                    ...
                    b.ToTable("DailyReportWorkItems");
                });
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("BirthDateEncrypted")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.Project", b =>
                {
                    ...
                    b.Property<string>("OwnerContact1Cell")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("OwnerContact1Email")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("OwnerContact1Name")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("OwnerContact1Phone")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("OwnerContact1Title")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("OwnerContact2Cell")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("OwnerContact2Email")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("OwnerContact2Name")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("OwnerContact2Phone")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("OwnerContact2Title")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.SafetyWkRepFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.WeatherCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReport", b =>
                {
                    ...
                    b.HasOne("ACI.Web.Data.Entities.ApplicationUser", "AuthoredBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.DailyReportCrewEntry", b =>
                {
                    b.HasOne("ACI.Web.Data.Entities.DailyReport", "DailyReport")
                        .WithMany("CrewEntries")
            ...
            modelBuilder.Entity("ACI.Web.Data.Entities.SafetyWkRepFile", b =>
                {
                    b.HasOne("ACI.Web.Data.Entities.SafetyWkRep", "Report")
                        .WithMany("Files")
