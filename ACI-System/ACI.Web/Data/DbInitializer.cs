    ...
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        if (!db.JobPositions.Any())
        {
            var positions = new List<JobPosition>
            {
                ...
                new() { Code = "SPM",   Name = "Senior PM",                OrdNum = 300,  Type = "Project" },
                new() { Code = "PM",    Name = "Project Manager",          OrdNum = 400,  Type = "Project" },
                new() { Code = "PE",    Name = "Project Engineer",         OrdNum = 500,  Type = "Project" },
                new() { Code = "APM",   Name = "Assistant PM",             OrdNum = 600,  Type = "Project" },
                new() { Code = "SUPT",  Name = "Superintendent",           OrdNum = 700,  Type = "Project" },
                new() { Code = "SSUPT", Name = "Senior Superintendent",    OrdNum = 750,  Type = "Project" },
                new() { Code = "ASUPT", Name = "Assistant Superintendent", OrdNum = 800,  Type = "Project" },
        ...
        if (!db.Projects.Any())
        {
            var project = new Project
            {
                ...
                OwnerContact1Email  = "procurement@lacity.org",
